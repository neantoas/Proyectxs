...
export default async function (m, conn = { user: {} }) {
 ...
 console.log(`${chalk.green('╭────═[ LeettsitaBot BOT - MD ]═─────⋆')}
${chalk.green('│╭───────────────···')}
${chalk.green('││')}👨‍💻 ${chalk.cyan('%s')} ⏱️ ${chalk.black(chalk.bgBlue('%s'))} 📂 ${chalk.black(chalk.bgGreen('%s'))} ${chalk.magenta('%s [%s %sB]')} 
${chalk.green('││')}🥷 ${chalk.redBright('%s')} 🏦 ${chalk.yellow('%s%s')} ${chalk.blueBright('en')} 
${chalk.green('││')}💻 ${chalk.cyan('%s')} ${chalk.black(chalk.bgBlue('%s'))}
${chalk.green('│╰────────────────···')}
${chalk.green('╰─────═•BY LeettsitaBot•═─────')}`.trim(), 
